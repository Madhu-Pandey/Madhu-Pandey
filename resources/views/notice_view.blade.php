...
@if(isset($notice))
<section class="section section-lg bg-icon bg-custom context-dark text-center text-md-left"
    data-preset='{"title":"Team","category":"team","reload":false,"id":"team"}'>
    <div class="bg-custom-inner bg-dark novi-bg novi-bg-img"></div>
    <div class="container">
        <h2 class="text-center text-xs-left">
            <!--Brand--><span class="text-logo"><span>News</span></span>
        </h2>
        <div class="row">
            @foreach ($notice as $n)
            <div class="col-sm-6" style="padding:25px">
                <div class="person-boxed">
                    <?php if(isset($n->ref_file) && is_array(json_decode($n->ref_file))){ ?>
                    <?php if(!(file_exists(asset('uploads/'.json_decode($n->ref_file)[0])))) { ?>
                    <!-- <a href="{{url('notice_view').'/'.md5($n->id)}}"> -->
                    <a href="#">
                    <img class="person-boxed-img" src="{{asset('uploads/'.json_decode($n->ref_file)[0])}}" alt=""
                        width="400" height="450" loading="lazy" /></a>
                    <?php } }else{
                        echo("File Not Found...!!");
                    } ?>
                    <div class="person-boxed-body">
                        <div class="person-boxed-title h4">{{$n->title}}</div>
                        <!-- <div class="person-boxed-meta">Crossfit Coach</div> -->
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-carousel-1" data-items="1" data-autoplay="true"
            ...
            <div class="row row-30 row-fix justify-content-center align-items-center">
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/2.jpg"><img class="thumbnail-img" src="uploads/2.jpg"
                                alt="" style="width:400px; height:219px;" /></a></div>

                </div>
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/3.jpg"><img class="thumbnail-img" src="uploads/3.jpg"
                                alt="" style="width:400px; height:219px;" /></a></div>
                </div>
            </div>
            <div class="row row-30 row-fix justify-content-center align-items-center">
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/4.jpg"><img class="thumbnail-img" src="uploads/4.jpg"
                                alt="" style="width:400px; height:219px;" /></a></div>

                </div>
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/5.jpg"><img class="thumbnail-img" src="uploads/5.jpg"
                                alt="" style="width:400px; height:219px;" /></a></div>
            ...
            <div class="row row-30 row-fix justify-content-center align-items-center">
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/7.jpg"><img class="thumbnail-img" src="uploads/7.jpg"
                                alt="" style="width:400px; height:219px;" /></a></div>

                </div>
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/14.jpg"><img class="thumbnail-img"
                                src="uploads/14.jpg" alt="" style="width:400px; height:219px;" /></a></div>
            ...
            <div class="row row-30 row-fix justify-content-center align-items-center">
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/15.jpg"><img class="thumbnail-img"
                                src="uploads/15.jpg" alt="" style="width:400px; height:219px;" /></a></div>
                </div>
                <div class="col-md-6 col-xl-5 offset-xl-1">
                    <div class="thumbnail thumbnail-gallery mt-sm-3 mt-md-5"><a class="thumbnail-media"
                            data-lightgallery="item" href="uploads/13.jpg"><img class="thumbnail-img"
                                src="uploads/13.jpg" alt="" style="width:400px; height:219px;" /></a></div>
