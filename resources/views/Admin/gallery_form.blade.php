              ...
              <div class="col-xl-12 xl-100 box-col-12">
                ...
                <div class="card" id="form-card" >
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title" id="card-title">Add New Gallery Images</h4>
                            </div>
                        </div>
                        <br>
                        <form id="product-form" enctype="multipart/form-data" action="{{url('admin/gallery/submit')}}" method="post">@csrf
