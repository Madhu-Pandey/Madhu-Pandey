    ...
    <div class="row second-chart-list third-news-update">
        <div class="container-fluid">
            <div class="card" id="form-card" >
                <div class="card-header"><h3>Add New Notice</h3></div>
                <div class="card-body">
                    <div class="row">
                        <form id="product-form" enctype="multipart/form-data" action="{{url('admin/notice/submit')}}" method="post">@csrf
                           ...
                           <div class="form theme-form">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="field-3" class="form-label">Notice Title</label>
                                            <input type="text" name="title" class="form-control"
                                                id="title"  placeholder="Name of the Notice" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="ref_file[]" onchange="viewFile(this, 'main_viewer')" class="form-control"
                                                id="ref_file" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea9">Notice Description</label>
                                            <textarea class="form-control" placeholder="Description of Notice" name="descr" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                           </div>
